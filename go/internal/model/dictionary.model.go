...
type Dictionary struct {
	...
	RecyableItems    []string           `bson:"recyable_items" json:"recyable_items"`
	NonRecyableItems []string           `bson:"non_recyable_items" json:"non_recyable_items"`
	HowToRecycle     string             `bson:"how_to_recycle,omitempty" json:"how_to_recycle,omitempty"`
}
